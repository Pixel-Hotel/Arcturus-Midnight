        ...
        for (WiredMatchFurniSetting setting : this.settings) {
            ...
            if(!animation){
                ...
                if(this.position && !direction) {
                    room.sendComposer(new FloorItemOnRollerComposer(item, null, oldLocation, item.getZ(), newLocation, height ? setting.z : newLocation.getStackHeight(), 0, room).compose());
